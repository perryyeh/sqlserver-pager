...
----------------------------------------------------------------------------
-- 分页
-- 0.15.20070415.b By Yeat http://www.yeat.org
...
(
	...
	@sWhere nvarchar(1000),		--条件(可以为空,不需要where)
	@sOrderby nvarchar(1000),	--排序(可以为空,不需要order by,需要asc和desc字符)
